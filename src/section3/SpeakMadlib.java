...
String name1=JOptionPane.showInputDialog("Enter a type of liquid.");
		// Get the user to enter a body part
String name2=JOptionPane.showInputDialog("Enter a body part.");
		// Get the user to enter a verb
String name3=JOptionPane.showInputDialog("Enter a verb.");
		// Get the user to enter a place
String name4=JOptionPane.showInputDialog("Enter a place.");
...
JOptionPane.showMessageDialog(null, "Piranhas are more " +name+ " during the day, so cross the river at night. "+
