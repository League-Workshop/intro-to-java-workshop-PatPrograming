...
public class RobotTreasureHunt implements KeyEventDispatcher{
	...
	private void spaceBarWasPressed() {
		...
		JOptionPane.showMessageDialog(null, robotXLocation+","+ robotYLocation);
		// 7. If robot is at same location as the little girl
		//      --make a pop-up tell the robot where to go next
		if (robotXLocation>50&&robotXLocation<100)
		{
				JOptionPane.showMessageDialog(null, "Now go to the robot.");
		}
		...
		JOptionPane.showMessageDialog(null, "Now go to the pirate.");
